...
<head>
  ...
  <title>NamZone | connecting sellers of second-hand
  goods with potential buyers</title>
    ...
    <div class="container mt-5 ">
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <p class="mt-2">NamZone is a proudly Namibian platform dedicated to connecting sellers of quality second-hand
             goods with interested buyers across the country. Founded on the belief that everyone deserves affordable access
              to useful items, NamZone simplifies the process of buying and selling pre-owned products in a safe,
               transparent, and community-driven environment.</p>
        </div>
        <div class="col-md-5 mt-3">
          ...
          <hr>
          <p>At NamZone, we are committed to creating a reliable digital marketplace that supports local commerce,
             promotes sustainability, and fosters economic opportunities for all Namibians.
          </p>
